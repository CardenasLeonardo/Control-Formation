...
def launch_setup(context, *args, **kwargs):
    ...
    for i in range(n):
        ...
        # Líder: navegación por waypoints
        if ns == leader_id:
            actions.append(
                Node(
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'waypoints',
            default_value='0.0,0.0,5.0,0.0,5.0,5.0,0.0,5.0',
            description='Waypoints del líder como lista plana separada por comas: x0,y0,x1,y1,...'
        ),
