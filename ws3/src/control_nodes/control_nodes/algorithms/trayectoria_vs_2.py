...
#
# Módulo intercambiable, igual que TrayectoriaVS2: hoy es una V rígida
...
# el detalle — solo llama a compute_formation_offsets_2() y recibe el
...
def compute_formation_offsets_2(n_robots, theta_v, angle_v, d):
