...
from control_nodes.algorithms.pivot_giro import PivotGiroWaypoints
...
class PivotGiroWaypointsNode(Node):
    """
    Formación en V que alcanza una lista de waypoints uno por uno,
    orientándose primero (giro sobre pivote, ángulo más corto) y luego
    avanzando en línea recta. Spawnea un marcador de rombo dorado por
    cada waypoint, además de las esferas de referencia de la V.
    """
    ...
    def __init__(self):
        super().__init__('pivot_giro_waypoints_node')
        ...
        self.get_logger().info(
            f'PivotGiroWaypoints | n={self.n}  waypoints={len(self.waypoints)}  '
