...
{
  new (message_memory) multi_robot_interfaces::msg::RobotState(_init);
}

void RobotState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<multi_robot_interfaces::msg::RobotState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[4] = {
  {
    ...
    offsetof(multi_robot_interfaces::msg::RobotState, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multi_robot_interfaces::msg::RobotState, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multi_robot_interfaces::msg::RobotState, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multi_robot_interfaces::msg::RobotState, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotState_message_members = {
  ...
  4,  // number of fields
  sizeof(multi_robot_interfaces::msg::RobotState),
...
get_message_type_support_handle<multi_robot_interfaces::msg::RobotState>()
{
  return &::multi_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multi_robot_interfaces, msg, RobotState)() {
  return &::multi_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
