...
bool multi_robot_interfaces__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_robot_interfaces.msg._robot_state.RobotState", full_classname_dest, 50) == 0);
  }
  multi_robot_interfaces__msg__RobotState * ros_message = _ros_message;
  {  // robot_id
...
PyObject * multi_robot_interfaces__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_robot_interfaces.msg._robot_state");
