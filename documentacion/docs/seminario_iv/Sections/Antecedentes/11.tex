...
Del diagrama anterior, la estructura virtual asigna a cada vehículo su posición deseada girando con $R(\theta)$ y escalando con $L$ su lugar $\mathbf{r}_i$ dentro del cuerpo rígido:
\begin{equation*}
