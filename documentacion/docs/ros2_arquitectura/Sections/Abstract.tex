\begin{abstract}
Este documento describe la arquitectura de ejecución de ROS2 (Robot Operating System 2), siguiendo el flujo completo de información desde el comando escrito en la terminal hasta la instanciación de un módulo Python dentro de un nodo.
